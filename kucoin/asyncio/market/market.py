...
class AsyncMarketData(KucoinAsyncRestApi):
    ...
    async def get_currency_detail_v3(self, currency,chain=None):
        """
        Get Currency Detail
        ...
        if chain:
            params['chain']=chain
        return await self._request('GET', f'/api/v3/currencies/{currency}', params=params)
