...
class AsyncUserData(KucoinAsyncRestApi):
    ...
    async def flex_transfer(self, clientOid,amount,fromAccountType,type,toAccountType,
        ...
        return await self._request('POST', '/api/v3/accounts/universal-transfer', params=params)
